...
class BlendMatrixCustomNode(OpenMaya.MPxNode):
    name = 'blendMatrixCustom'
    id = OpenMaya.MTypeId(0x0013abc0)
...
def initializePlugin(plug):
    ...
    mplugin.registerNode(
        BlendMatrixCustomNode.name,
        BlendMatrixCustomNode.id,
        BlendMatrixCustomNode.create,
        BlendMatrixCustomNode.init,
        OpenMaya.MPxNode.kDependNode,
        BlendMatrixCustomNode.classify
    )


def uninitializePlugin(plug):
    mplugin = OpenMaya.MFnPlugin(plug)
    mplugin.deregisterNode(BlendMatrixCustomNode.id)
